...
const LastWord = (str) => {
    ...
    let lastWord = str.slice(lastIndex + 1);
    return lastWord;
}
// -------------------------------------------------------------------------------------------------------
...
const replaceWords = (str) => {
    ...
    // i => we
    let iIndex = arrWords.indexOf("I");
    if (iIndex !== -1) {
        arrWords.splice(iIndex, 1, "We");
    }
    // am => are
    let amIndex = arrWords.indexOf("am");
    if (amIndex !== -1) {
        arrWords.splice(amIndex, 1, "are");
    }
    //was => were
    let wasIndex = arrWords.indexOf("was");
    if (wasIndex !== -1) {
        arrWords.splice(wasIndex, 1, "were");
    }

    let newString = arrWords.join(' ');
    return newString;
}
// -------------------------------------------------------------------------------------------------------
