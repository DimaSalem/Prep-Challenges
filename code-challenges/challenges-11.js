...
function square(arr) {
    let reformattedArray = arr.map((num) => num * num)
...
function fullName(arr) {
    let reformattedArray = arr.map((person) => (person.firstName + " " + person.lastName));
...
function gradesAvg(arr) {
    let reformattedArray = arr.map(student => {
        let sum = 0;
